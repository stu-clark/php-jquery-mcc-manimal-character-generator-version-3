...
<html>
<head>
<title>Launch Page: Mutant Crawl Classics Manimal Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Mutant Crawl Classics Manimal Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/mcc/classes/manimal/"  class="text_link" target="_blank"><span class="bold">Artifacts of the Ancient Ones: A Mutant Crawl Classics Fan Site</span></a></p>
		...
		<form action="" id ="ManimalFormV3"  target="_blank" method="post">
    ...
    <div class="content9">
        ...
        <br/>
           ...
           <span class="footnote3"><input type="checkbox" id="randomMutationsV3" value="1" name="theRandomMutuations" onClick="hideMutations()">1d2 Physical & 1 Mental Mutations</span>
           </div>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#ManimalFormV3").attr('action', "character3/mccManimal.php");
